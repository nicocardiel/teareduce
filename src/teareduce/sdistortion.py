...
def fit_sdistortion(
    data, ns_min, ns_max, nc_min, nc_max, median_size=None, ywindow=5, degree_sdistortion=2, plots=True, **kwargs
):
    ...
    poly_funct_peaks, yres, reject = polfit_residuals_with_sigma_rejection(
        x=xpeak, y=ypeak, deg=degree_sdistortion, times_sigma_reject=3
    )
