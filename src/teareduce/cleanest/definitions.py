...
lacosmic_default_dict = {
    ...
    "run1_cleantype": {"value": "meanmask", "type": str,
                       "valid_values": ["median", "medmask", "meanmask", "idw"]},
    "run1_fsmode": {"value": "median", "type": str,
                    "valid_values": ["median", "convolve"]},
    "run1_psfmodel": {"value": "gaussxy", "type": str,
    ...
    "run2_cleantype": {"value": "meanmask", "type": str,
                       "valid_values": ["median", "medmask", "meanmask", "idw"]},
    "run2_fsmode": {"value": "median", "type": str,
                    "valid_values": ["median", "convolve"]},
    "run2_psfmodel": {"value": "gaussxy", "type": str,
                      "valid_values": ["gauss", "moffat", "gaussx", "gaussy", "gaussxy"]},
